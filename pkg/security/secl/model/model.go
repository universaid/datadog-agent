...
type Process struct {
	...
	ArgsEntry *ArgsEntry `field:"-" msg:"args" json:"-"`
	EnvsEntry *EnvsEntry `field:"-" msg:"envs" json:"-"`
...
type SpanContext struct {
	SpanID  uint64 `field:"_" msg:"span_id" json:"-"`
	TraceID uint64 `field:"_" msg:"trace_id" json:"-"`
}
